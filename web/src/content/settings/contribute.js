  ...
  return (
    <Card>
      ...
      <Table>
        ...
        <Row title={l`Donate`} detail={<Link href={DONATE_URL} target='_blank' className={S.caps}>ko-fi.com</Link>} />
        <Row title={l`Contribute`} detail={<Link href={REPOSITORY_URL} target='_blank' className={S.caps}>github.com</Link>} />
      </Table>
    </Card>
  )
}
