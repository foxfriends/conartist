  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct AddUserConvention: GraphQLSelectionSet {
      ...
      public init(id: Int, name: String, images: [Image], start: String, end: String, extraInfo: [ExtraInfo], userInfo: [UserInfo], recordTotal: String? = nil, expenseTotal: String? = nil) {
        self.init(unsafeResultMap: ["__typename": "Convention", "id": id, "name": name, "images": images.map { (value: Image) -> ResultMap in value.resultMap }, "start": start, "end": end, "extraInfo": extraInfo.map { (value: ExtraInfo) -> ResultMap in value.resultMap }, "userInfo": userInfo.map { (value: UserInfo) -> ResultMap in value.resultMap }, "recordTotal": recordTotal, "expenseTotal": expenseTotal])
      }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Convention: GraphQLSelectionSet {
      ...
      public init(id: Int, name: String, images: [Image], start: String, end: String, extraInfo: [ExtraInfo], userInfo: [UserInfo], recordTotal: String? = nil, expenseTotal: String? = nil, products: [Product], productTypes: [ProductType], prices: [Price], records: [Record], expenses: [Expense]) {
        self.init(unsafeResultMap: ["__typename": "Convention", "id": id, "name": name, "images": images.map { (value: Image) -> ResultMap in value.resultMap }, "start": start, "end": end, "extraInfo": extraInfo.map { (value: ExtraInfo) -> ResultMap in value.resultMap }, "userInfo": userInfo.map { (value: UserInfo) -> ResultMap in value.resultMap }, "recordTotal": recordTotal, "expenseTotal": expenseTotal, "products": products.map { (value: Product) -> ResultMap in value.resultMap }, "productTypes": productTypes.map { (value: ProductType) -> ResultMap in value.resultMap }, "prices": prices.map { (value: Price) -> ResultMap in value.resultMap }, "records": records.map { (value: Record) -> ResultMap in value.resultMap }, "expenses": expenses.map { (value: Expense) -> ResultMap in value.resultMap }])
      }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct User: GraphQLSelectionSet {
      ...
      public init(name: String, email: String, settings: Setting, conventions: [Convention], clearance: Int, products: [Product], productTypes: [ProductType], prices: [Price]) {
        self.init(unsafeResultMap: ["__typename": "User", "name": name, "email": email, "settings": settings.resultMap, "conventions": conventions.map { (value: Convention) -> ResultMap in value.resultMap }, "clearance": clearance, "products": products.map { (value: Product) -> ResultMap in value.resultMap }, "productTypes": productTypes.map { (value: ProductType) -> ResultMap in value.resultMap }, "prices": prices.map { (value: Price) -> ResultMap in value.resultMap }])
      }
