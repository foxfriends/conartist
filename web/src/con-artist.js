...
export class ConArtist extends React.Component {
  ...
  computeState(model, toolbar) {
    ...
    switch (model.page.name) {
      case "splash":
        state.toolbar = {
          primary: toolbarAction.SignUp,
          secondary: toolbarAction.LogIn,
          tertiary: null,
        };
      ...
      case "discounts":
        state.toolbar = {
          primary: toolbarAction.EditDiscounts,
          secondary: null,
          tertiary: null,
          pageIcon: "percent",
        };
      ...
      case "sales":
        state.toolbar = {
          primary: toolbarAction.NewSale,
          secondary: null,
          tertiary: null,
          pageIcon: "table_chart",
        };
      ...
      case "conventions":
        state.toolbar = {
          primary: toolbarAction.SearchConventions,
          secondary: null,
          tertiary: null,
          pageIcon: "event",
        };
      ...
      case "search-conventions":
        const updateSearch = (search) =>
          this.setState({ content: { ...this.state.content, search } });
        const showFilters = () =>
          this.setState({
            content: {
              ...this.state.content,
              advanced: !this.state.content.advanced,
            },
          });
        state.toolbar = {
          textField: {
      ...
      case "convention-records":
        ...
        state.toolbar = {
          primary: null,
          secondary: toolbarAction.ExportRecords(convention),
          tertiary: null,
          pageIcon: "event",
        };
      ...
      case "suggestions":
        state.toolbar = {
          primary: toolbarAction.CreateSuggestion,
          secondary: null,
          tertiary: null,
          pageIcon: "settings",
        };
      ...
      case "reset-password":
        state.toolbar = {
          primary: isSignedIn() ? null : toolbarAction.LogIn,
          secondary: null,
          tertiary: null,
        };
        state.navigation = null;
        ...
        content: (
          <>
            ...
            <Button
              ...
              priority="primary"
              action={() => new ResendVerificationEmail().send().subscribe()}
            >
